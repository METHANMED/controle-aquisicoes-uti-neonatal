...
import { BadgeDollarSign, Boxes, Clock3, Search, Store } from "lucide-react";
...
export default function QuoteComparison() {
  ...
  return <div className="enter-soft"><PageHeader eyebrow="Gerenciamento · fornecedores" title="Comparação de propostas" description="Visualize os valores enviados pelos fornecedores, identifique a menor proposta por item e compare prazos, marcas e modelos ofertados." />
